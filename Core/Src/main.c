...
Encoder_HandleTypeDef *RIGHT_encoder = &htim3;
Encoder_HandleTypeDef *LEFT_encoder = &htim5;
PWM_HandleTypeDef *LEFT_motor_pwm = &htim9;
PWM_HandleTypeDef *RIGHT_motor_pwm = &htim9;
TIM_HandleTypeDef *encoder_timer = &htim6;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(LEFT_MOTOR_N_GPIO_Port, LEFT_MOTOR_N_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, LED1_Pin|LED2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, RIGHT_MOTOR_P_Pin|RIGHT_MOTOR_N_Pin|LEFT_MOTOR_P_Pin|ULTRASONIC_TRIG_Pin
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, SOFT_I2C_SCL_Pin|SOFT_I2C_SDA_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : LEFT_MOTOR_N_Pin LED1_Pin LED2_Pin */
  GPIO_InitStruct.Pin = LEFT_MOTOR_N_Pin|LED1_Pin|LED2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

  /*Configure GPIO pins : RIGHT_MOTOR_P_Pin RIGHT_MOTOR_N_Pin ULTRASONIC_TRIG_Pin ULTRASONIC_ECHO_Pin */
  GPIO_InitStruct.Pin = RIGHT_MOTOR_P_Pin|RIGHT_MOTOR_N_Pin|ULTRASONIC_TRIG_Pin|ULTRASONIC_ECHO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : LEFT_MOTOR_P_Pin */
  GPIO_InitStruct.Pin = LEFT_MOTOR_P_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LEFT_MOTOR_P_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SOFT_I2C_SCL_Pin SOFT_I2C_SDA_Pin */
