...
void s6d04d1::setScanMode(MyDrivers::scanMode mode)
{
    ...
    switch (mode)
    {
    case MyDrivers::scanMode::L2R_U2D:
        if (dir == MyDrivers::displayDir::vertical) {
            regValue |= (0<<7)|(0<<6)|(0<<5);
        } else {
            regValue |= (1<<7)|(0<<6)|(1<<5);
        }
        break;
    case MyDrivers::scanMode::L2R_D2U:
        if (dir == MyDrivers::displayDir::vertical) {
        ...
        break;
    case MyDrivers::scanMode::R2L_U2D:
        if (dir == MyDrivers::displayDir::vertical) {
        ...
        break;
    case MyDrivers::scanMode::R2L_D2U:
        if (dir == MyDrivers::displayDir::vertical) {
        ...
        break;
    case MyDrivers::scanMode::U2D_L2R:
        if (dir == MyDrivers::displayDir::vertical) {
            regValue |= (0<<7)|(0<<6)|(1<<5);
        } else {
            regValue |= (1<<7)|(0<<6)|(0<<5); 
        ...
        break;
    case MyDrivers::scanMode::U2D_R2L:
        if (dir == MyDrivers::displayDir::vertical) {
            regValue |= (0<<7)|(1<<6)|(1<<5);
        } else {
            regValue |= (0<<7)|(0<<6)|(0<<5); 
        ...
        break;
    case MyDrivers::scanMode::D2U_L2R:
        if (dir == MyDrivers::displayDir::vertical) {
            regValue |= (1<<7)|(0<<6)|(1<<5); 
        } else {
            regValue |= (1<<7)|(1<<6)|(0<<5); 
        ...
        break;
    case MyDrivers::scanMode::D2U_R2L:
        if (dir == MyDrivers::displayDir::vertical) {
            regValue |= (1<<7)|(1<<6)|(1<<5); 
        } else {
            regValue |= (0<<7)|(1<<6)|(0<<5);
